...
class ImageToImageUsingImageStrengthRequestBody {
  ...
  /// Returns a new [ImageToImageUsingImageStrengthRequestBody] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ImageToImageUsingImageStrengthRequestBody? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return ImageToImageUsingImageStrengthRequestBody(
  ...
  static List<ImageToImageUsingImageStrengthRequestBody> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ImageToImageUsingImageStrengthRequestBody.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
