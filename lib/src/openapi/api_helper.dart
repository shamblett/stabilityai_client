...
String parameterToString(dynamic value) {
  ...
  if (value is ClipGuidancePreset) {
    return ClipGuidancePresetTypeTransformer().encode(value).toString();
  }
  if (value is FinishReason) {
    return FinishReasonTypeTransformer().encode(value).toString();
  }
  if (value is InitImageMode) {
    return InitImageModeTypeTransformer().encode(value).toString();
  }
  if (value is Sampler) {
    return SamplerTypeTransformer().encode(value).toString();
  }
  if (value is StylePreset) {
    return StylePresetTypeTransformer().encode(value).toString();
  }
