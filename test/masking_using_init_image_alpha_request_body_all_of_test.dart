...
// tests for MaskingUsingInitImageAlphaRequestBodyAllOf
void main() {
  // final instance = MaskingUsingInitImageAlphaRequestBodyAllOf();

  group('test MaskingUsingInitImageAlphaRequestBodyAllOf', () {
